...
A demonstration of the general ablation-based pipeline, consisting of knowledge elicitation (from GPT-4) and knowl-edge 
transfer via labeling, feedback (RO/RL), or their combi- nation.
...
::: {.g-col-12 .g-col-md-4}
![](images/){.pub-teaser fig-align="center"}
:::
