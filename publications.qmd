...
![](images/papers/IoTBec.png){#fig-iie-method width=90%}

Figure 1. IoTBec Workflow

![](images/papers/IoTBec_2.png){#fig-iie-method width=90%}

Figure 2. Illustration of Vulnerability Signature Extraction with the Vulnerability Analyzer LLM

![](images/papers/IoTBec_3.png){#fig-iie-method width=90%}
...
![](images/papers/KD.png){#fig-iie-method width=90%}
Figure 1. Workflow
